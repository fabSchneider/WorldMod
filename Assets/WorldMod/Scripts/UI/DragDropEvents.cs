...
namespace Fab.WorldMod.UI
{
    ...
    public class FabDragExitedEvent : FabDragAndDropEventBase<FabDragExitedEvent>
    {
        ...
        //public new static FabDragExitedEvent GetPooled(Event systemEvent)
        //{
        ...
        //    return FabDragAndDropEventBase<FabDragExitedEvent>.GetPooled(systemEvent);
        //}
    ...
    public class FabDragUpdatedEvent : FabDragAndDropEventBase<FabDragUpdatedEvent>
    {
        ...
        ///// <returns>An initialized event.</returns>
        //public new static FabDragUpdatedEvent GetPooled(Event systemEvent)
        //{
        ...
        //    FabDragUpdatedEvent e = FabDragAndDropEventBase<FabDragUpdatedEvent>.GetPooled(systemEvent);
        //    e.button = 0;
        //    return e;
        //}

        //internal static FabDragUpdatedEvent GetPooled(PointerMoveEvent pointerEvent)
        //{
        //    return FabDragAndDropEventBase<FabDragUpdatedEvent>.GetPooled(pointerEvent);
        //}
